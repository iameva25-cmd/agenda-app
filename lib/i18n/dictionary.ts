...
const dictionary: Record<string, string> = {
  ...
  "Go to next day": "Ke hari berikutnya",
  "Go to previous day": "Ke hari sebelumnya",
  ...
  "Align with objective": "Selaraskan dengan objective",
  "No objectives set for this week": "Belum ada objective untuk minggu ini",
